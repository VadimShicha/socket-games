...
function SignUpPage()
{
    ...
    function createExample(user)
    {
        if(user == "both")
        {
            sendPOST({requestID: "create_user", firstName: "bob", lastName: "Smith", username: "bob", password: "bobissad", confirmPassword: "bobissad"}, function(data)
            {
                setMessage(data.message);
            });

            sendPOST({requestID: "create_user", firstName: "sally", lastName: "Smith", username: "sally", password: "bobissad", confirmPassword: "bobissad"}, function(data)
            {
                setMessage(data.message);
            });
            return;
        }
        sendPOST({requestID: "create_user", firstName: user, lastName: "Smith", username: user, password: "bobissad", confirmPassword: "bobissad"}, function(data)
        {
            setMessage(data.message);
